...
**The call:** Verify the conventions `bin/render-copilot.mjs` targets match how **your** GitHub Copilot Enterprise reads them: orchestrators → `.github/chatmodes/*.chatmode.md`, sub-agents → `.github/agents/<category>/`, instructions → `.github/instructions/*.instructions.md`.
